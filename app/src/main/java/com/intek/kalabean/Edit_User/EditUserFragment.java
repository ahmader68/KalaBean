...
//                }
        ...
        btnFragmentEditUserSupport.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
...
//            edtFragmentEditUserPhone.setHint("فیلد تلفن خالی است");
//            edtFragmentEditUserPhone.setHintTextColor(getResources().getColor(R.color.colorRed));
//            return false;
//        } else {
//            return true;
//        }
...
//            edtFragmentEditUserPassword.setHint("فیلد کلمه عبور خالی است");
//            edtFragmentEditUserPassword.setHintTextColor(getResources().getColor(R.color.colorRed));
//            return false;
//        } else {
//            return true;
//        }
...
//            edtFragmentEditUserConfPass.setHint("فیلد تکرار کلمه عبور خالی است");
//            edtFragmentEditUserConfPass.setHintTextColor(getResources().getColor(R.color.colorRed));
//            return false;
//        } else {
//            return true;
